...
public class UserRepository {
    ...
    public String saveWithReturningUuid(Users user) {
        UsersRecord usersRecord = dslContext.newRecord(USERS, user);
        usersRecord.insert();
        user.setUserId(usersRecord.getUserId());
        return usersRecord.getUuid();
    }
